...
import com.lucassoares.lumovie.databinding.TopRatedMovieBinding
...

{
    ...
    private inner class ConcatViewHolder ( val binding: TopRatedMovieBinding) : BaseConcatHolder<MovieAdapter>(binding.root){
