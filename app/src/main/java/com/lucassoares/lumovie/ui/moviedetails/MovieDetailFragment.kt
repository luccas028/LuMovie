package com.lucassoares.lumovie.ui.moviedetails
...
import com.lucassoares.lumovie.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       binding.txtDescription.text = args.overview
        ...
        binding.txtReleased.text = "Relase Date ${args.releaseDate}"
